...
// ⭐️ FIXED IMPORT: Assuming faqContent is a named export from the assets file
// You may need to change this if 'assets' is a default export object containing faqContent
    ...
    return (
        ...
        >
            <div className="container mx-auto px-4 sm:px-12 lg:px-24 xl:px-40">
                ...
                <motion.div
                    variants={sectionVariants}
                    className="max-w-4xl mx-auto rounded-xl shadow-2xl overflow-hidden will-change-transform"
                >
